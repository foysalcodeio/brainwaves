...
const handleClick = () => {
  ...
  return (
    <div className={`
    fixed border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm top-0 left-0 z-50 w-full
    ${openNavigation ? "bg-n-8" : "bg-n-8/90 backdrop-blur-sm"}
    `}>
      <div className='flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4 '>
        <a className='block xl:mr-8 w-[12rem] z-50' href="#hero">
          <img src={brainwave} width={190} height={40} alt="brainwave" />
        </a>

        <nav className={`${openNavigation ? 'flex' : 'hidden'}
          top-[5rem] left-0 right-0 bg-n-8 bottom-0 lg:static lg:flex lg:mx-auto lg:bg-transparent fixed`}>
